...
$backupLocation = "C:\mywork\ps\HODS-B\backup\HYDRO01HODS-2012APR24.bak"
$SiteUrl = "http://hodsdev.hydroone.com"

#Remove-Readonly -FilePath $backupLocation
Restore-SPBackup -BackupFilePath $backupLocation -WebUrl $SiteUrl
